...
public class ALRArrayOfServiceItems extends Vector<ALRServiceItem> implements KvmSerializable {
    ...
    public void loadFromSoap(java.lang.Object inObj, ALRExtendedSoapSerializationEnvelope __envelope) {
        ...
        for (int i0 = 0; i0 < size; i0++) {
            ...
            if (obj != null && obj instanceof AttributeContainer) {
                ...
                ALRServiceItem j1 = (ALRServiceItem) __envelope.get(j, ALRServiceItem.class, false);
                add(j1);
            }
        }
    }
