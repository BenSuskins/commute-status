...
public class ALRStationBoardWithDetails extends ALRBaseStationBoard implements KvmSerializable {

    public ALRArrayOfServiceItemsWithCallingPoints trainServices;

    public ALRArrayOfServiceItemsWithCallingPoints busServices;

    public ALRArrayOfServiceItemsWithCallingPoints ferryServices;
    ...
    protected boolean loadProperty(PropertyInfo info, SoapObject soapObject, ALRExtendedSoapSerializationEnvelope __envelope) {
        ...
        if (info.name.equals("trainServices")) {
            if (obj != null) {
                ...
                this.trainServices = (ALRArrayOfServiceItemsWithCallingPoints) __envelope.get(j, ALRArrayOfServiceItemsWithCallingPoints.class, false);
            }
            return true;
        }
        if (info.name.equals("busServices")) {
            if (obj != null) {
                java.lang.Object j = obj;
                this.busServices = (ALRArrayOfServiceItemsWithCallingPoints) __envelope.get(j, ALRArrayOfServiceItemsWithCallingPoints.class, false);
            }
            return true;
        }
        if (info.name.equals("ferryServices")) {
            if (obj != null) {
                java.lang.Object j = obj;
                this.ferryServices = (ALRArrayOfServiceItemsWithCallingPoints) __envelope.get(j, ALRArrayOfServiceItemsWithCallingPoints.class, false);
            }
            return true;
        }
