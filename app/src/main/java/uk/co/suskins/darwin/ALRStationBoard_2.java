...
public class ALRStationBoard_2 extends ALRBaseStationBoard implements KvmSerializable {

    public ALRArrayOfServiceItems_2 trainServices;

    public ALRArrayOfServiceItems_2 busServices;

    public ALRArrayOfServiceItems_2 ferryServices;
    ...
    protected boolean loadProperty(PropertyInfo info, SoapObject soapObject, ALRExtendedSoapSerializationEnvelope __envelope) {
        ...
        if (info.name.equals("trainServices")) {
            if (obj != null) {
                ...
                this.trainServices = (ALRArrayOfServiceItems_2) __envelope.get(j, ALRArrayOfServiceItems_2.class, false);
            }
            return true;
        }
        if (info.name.equals("busServices")) {
            if (obj != null) {
                java.lang.Object j = obj;
                this.busServices = (ALRArrayOfServiceItems_2) __envelope.get(j, ALRArrayOfServiceItems_2.class, false);
            }
            return true;
        }
        if (info.name.equals("ferryServices")) {
            if (obj != null) {
                java.lang.Object j = obj;
                this.ferryServices = (ALRArrayOfServiceItems_2) __envelope.get(j, ALRArrayOfServiceItems_2.class, false);
            }
            return true;
        }
