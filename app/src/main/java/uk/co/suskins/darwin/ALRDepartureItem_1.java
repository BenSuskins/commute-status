...
public class ALRDepartureItem_1 extends AttributeContainer implements KvmSerializable {

    public ALRServiceItem_1 service;
    ...
    protected boolean loadProperty(PropertyInfo info, SoapObject soapObject, ALRExtendedSoapSerializationEnvelope __envelope) {
        ...
        if (info.name.equals("service")) {
            if (obj != null) {
                ...
                this.service = (ALRServiceItem_1) __envelope.get(j, ALRServiceItem_1.class, false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        if (propertyIndex == 0) {
            info.type = ALRServiceItem_1.class;
            info.name = "service";
