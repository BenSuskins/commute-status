...
public class ALRDepartureItem extends AttributeContainer implements KvmSerializable {

    public ALRServiceItem service;
    ...
    protected boolean loadProperty(PropertyInfo info, SoapObject soapObject, ALRExtendedSoapSerializationEnvelope __envelope) {
        ...
        if (info.name.equals("service")) {
            if (obj != null) {
                ...
                this.service = (ALRServiceItem) __envelope.get(j, ALRServiceItem.class, false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        if (propertyIndex == 0) {
            info.type = ALRServiceItem.class;
            info.name = "service";
