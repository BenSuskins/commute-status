...
public class ALRDeparturesBoard_1 extends ALRBaseStationBoard implements KvmSerializable {

    public ALRArrayOfDepartureItems_1 departures = new ALRArrayOfDepartureItems_1();
    ...
    protected boolean loadProperty(PropertyInfo info, SoapObject soapObject, ALRExtendedSoapSerializationEnvelope __envelope) {
        ...
        if (info.name.equals("departures")) {
            if (obj != null) {
                ...
                this.departures = (ALRArrayOfDepartureItems_1) __envelope.get(j, ALRArrayOfDepartureItems_1.class, false);
            }
            return true;
        }
