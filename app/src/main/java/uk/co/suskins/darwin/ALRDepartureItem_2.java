...
public class ALRDepartureItem_2 extends AttributeContainer implements KvmSerializable {

    public ALRServiceItem_2 service;
    ...
    protected boolean loadProperty(PropertyInfo info, SoapObject soapObject, ALRExtendedSoapSerializationEnvelope __envelope) {
        ...
        if (info.name.equals("service")) {
            if (obj != null) {
                ...
                this.service = (ALRServiceItem_2) __envelope.get(j, ALRServiceItem_2.class, false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        if (propertyIndex == 0) {
            info.type = ALRServiceItem_2.class;
            info.name = "service";
