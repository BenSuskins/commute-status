...
public class ALRDepartureItemWithCallingPoints extends AttributeContainer implements KvmSerializable {

    public ALRServiceItemWithCallingPoints service;
    ...
    protected boolean loadProperty(PropertyInfo info, SoapObject soapObject, ALRExtendedSoapSerializationEnvelope __envelope) {
        ...
        if (info.name.equals("service")) {
            if (obj != null) {
                ...
                this.service = (ALRServiceItemWithCallingPoints) __envelope.get(j, ALRServiceItemWithCallingPoints.class, false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        if (propertyIndex == 0) {
            info.type = ALRServiceItemWithCallingPoints.class;
            info.name = "service";
