...
public class ALRDeparturesBoardWithDetails extends ALRBaseStationBoard implements KvmSerializable {

    public ALRArrayOfDepartureItemsWithCallingPoints departures = new ALRArrayOfDepartureItemsWithCallingPoints();
    ...
    protected boolean loadProperty(PropertyInfo info, SoapObject soapObject, ALRExtendedSoapSerializationEnvelope __envelope) {
        ...
        if (info.name.equals("departures")) {
            if (obj != null) {
                ...
                this.departures = (ALRArrayOfDepartureItemsWithCallingPoints) __envelope.get(j, ALRArrayOfDepartureItemsWithCallingPoints.class, false);
            }
            return true;
        }
