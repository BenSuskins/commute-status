...
public class ALRDeparturesBoardWithDetails_1 extends ALRBaseStationBoard implements KvmSerializable {

    public ALRArrayOfDepartureItemsWithCallingPoints_1 departures = new ALRArrayOfDepartureItemsWithCallingPoints_1();
    ...
    protected boolean loadProperty(PropertyInfo info, SoapObject soapObject, ALRExtendedSoapSerializationEnvelope __envelope) {
        ...
        if (info.name.equals("departures")) {
            if (obj != null) {
                ...
                this.departures = (ALRArrayOfDepartureItemsWithCallingPoints_1) __envelope.get(j, ALRArrayOfDepartureItemsWithCallingPoints_1.class, false);
            }
            return true;
        }
