...
public class ALRStationBoard extends ALRBaseStationBoard implements KvmSerializable {

    public ALRArrayOfServiceItems trainServices;

    public ALRArrayOfServiceItems busServices;

    public ALRArrayOfServiceItems ferryServices;
    ...
    protected boolean loadProperty(PropertyInfo info, SoapObject soapObject, ALRExtendedSoapSerializationEnvelope __envelope) {
        ...
        if (info.name.equals("trainServices")) {
            if (obj != null) {
                ...
                this.trainServices = (ALRArrayOfServiceItems) __envelope.get(j, ALRArrayOfServiceItems.class, false);
            }
            return true;
        }
        if (info.name.equals("busServices")) {
            if (obj != null) {
                java.lang.Object j = obj;
                this.busServices = (ALRArrayOfServiceItems) __envelope.get(j, ALRArrayOfServiceItems.class, false);
            }
            return true;
        }
        if (info.name.equals("ferryServices")) {
            if (obj != null) {
                java.lang.Object j = obj;
                this.ferryServices = (ALRArrayOfServiceItems) __envelope.get(j, ALRArrayOfServiceItems.class, false);
            }
            return true;
        }
