...
public class ALRStationBoardWithDetails_1 extends ALRBaseStationBoard implements KvmSerializable {

    public ALRArrayOfServiceItemsWithCallingPoints_1 trainServices;

    public ALRArrayOfServiceItemsWithCallingPoints_1 busServices;

    public ALRArrayOfServiceItemsWithCallingPoints_1 ferryServices;
    ...
    protected boolean loadProperty(PropertyInfo info, SoapObject soapObject, ALRExtendedSoapSerializationEnvelope __envelope) {
        ...
        if (info.name.equals("trainServices")) {
            if (obj != null) {
                ...
                this.trainServices = (ALRArrayOfServiceItemsWithCallingPoints_1) __envelope.get(j, ALRArrayOfServiceItemsWithCallingPoints_1.class, false);
            }
            return true;
        }
        if (info.name.equals("busServices")) {
            if (obj != null) {
                java.lang.Object j = obj;
                this.busServices = (ALRArrayOfServiceItemsWithCallingPoints_1) __envelope.get(j, ALRArrayOfServiceItemsWithCallingPoints_1.class, false);
            }
            return true;
        }
        if (info.name.equals("ferryServices")) {
            if (obj != null) {
                java.lang.Object j = obj;
                this.ferryServices = (ALRArrayOfServiceItemsWithCallingPoints_1) __envelope.get(j, ALRArrayOfServiceItemsWithCallingPoints_1.class, false);
            }
            return true;
        }
