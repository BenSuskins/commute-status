...
public class ALRDepartureItemWithCallingPoints_2 extends AttributeContainer implements KvmSerializable {

    public ALRServiceItemWithCallingPoints_2 service;
    ...
    protected boolean loadProperty(PropertyInfo info, SoapObject soapObject, ALRExtendedSoapSerializationEnvelope __envelope) {
        ...
        if (info.name.equals("service")) {
            if (obj != null) {
                ...
                this.service = (ALRServiceItemWithCallingPoints_2) __envelope.get(j, ALRServiceItemWithCallingPoints_2.class, false);
            }
            return true;
        }
        return false;
