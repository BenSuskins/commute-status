...
public class ALRArrayOfDepartureItems_1 extends Vector<ALRDepartureItem_1> implements KvmSerializable {
    ...
    public void loadFromSoap(java.lang.Object inObj, ALRExtendedSoapSerializationEnvelope __envelope) {
        ...
        for (int i0 = 0; i0 < size; i0++) {
            ...
            if (obj != null && obj instanceof AttributeContainer) {
                ...
                ALRDepartureItem_1 j1 = (ALRDepartureItem_1) __envelope.get(j, ALRDepartureItem_1.class, false);
                add(j1);
            }
        }
    }
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        ...
        info.type = ALRDepartureItem_1.class;
