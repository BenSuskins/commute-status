...
public class ALRDeparturesBoard extends ALRBaseStationBoard implements KvmSerializable {

    public ALRArrayOfDepartureItems departures = new ALRArrayOfDepartureItems();
    ...
    protected boolean loadProperty(PropertyInfo info, SoapObject soapObject, ALRExtendedSoapSerializationEnvelope __envelope) {
        ...
        if (info.name.equals("departures")) {
            if (obj != null) {
                ...
                this.departures = (ALRArrayOfDepartureItems) __envelope.get(j, ALRArrayOfDepartureItems.class, false);
            }
            return true;
        }
