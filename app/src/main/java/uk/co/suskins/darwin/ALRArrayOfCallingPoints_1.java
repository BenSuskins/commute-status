...
public class ALRArrayOfCallingPoints_1 extends AttributeContainer implements KvmSerializable {

    public ArrayList<ALRCallingPoint_1> callingPoint = new ArrayList<ALRCallingPoint_1>();
        ...
        if (info.name.equals("callingPoint")) {
            if (obj != null) {
                if (this.callingPoint == null) {
                    this.callingPoint = new java.util.ArrayList<ALRCallingPoint_1>();
                }
                java.lang.Object j = obj;
                ALRCallingPoint_1 j1 = (ALRCallingPoint_1) __envelope.get(j, ALRCallingPoint_1.class, false);
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        if (propertyIndex >= 0 && propertyIndex < 0 + this.callingPoint.size()) {
            info.type = ALRCallingPoint_1.class;
